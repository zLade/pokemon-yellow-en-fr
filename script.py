...
p(0x0301D7, "0000000000 sauvage apparaît !")
p(0x0301F9, " est K.O. !")
p(0x030203, " EXP gagn. !")  # Variante fixe de 12 cases
p(0x030210, "Vous prenez la fuite !")
p(0x030221, "Sacha lance une ")
p(0x03022A, "Oui ! ")
p(0x030230, "000000000Oh non ! ")
p(0x030242, " s'est libéré !")
p(0x03024E, "00000000 est capturé !")
p(0x030262, "0envoie ")
p(0x03026D, "Fuite impossible !")
p(0x030290, "Voler, c'est mal !")
p(0x0302A9, "0000000000À toi !")
p(0x0302BF, " utilise ")
p(0x0302C5, "Coup normal !")
p(0x0302CF, "0Peu efficace...")
p(0x0302EE, " est empoisonné !")
p(0x0302FA, " est intoxiqué !")
p(0x030304, " est brûlé !")
p(0x03030E, " est confus !")
p(0x03031A, " est gelé !")
p(0x030324, "000000 souffre du poison !")
p(0x030341, " dort !")
p(0x03034B, "0 brûle !")
p(0x030364, "000 se blesse !")
p(0x030373, "0000 est gelé !")
p(0x0303A9, " au maximum !")
p(0x0303D6, " au minimum !")
p(0x030409, " évolue !")
p(0x030428, " apprend")
p(0x03043F, "000000déjà 4 attaques !")
p(0x03045F, "L'attaque ")
p(0x030479, "Quelle attaque ?")
p(0x03048C, " monte fort !")
p(0x03049A, "000Attaque apprise :")
p(0x0304A9, " ?")
p(0x0304AB, "00000000 n'apprend pas")
p(0x030660, "0000000000000Changer de Pokémon ?")
...
p(0x030919, "00000000Indisponible")
p(0x030955, "00000000000000000PV restaurés !")
p(0x030AB5, " EXP gagnés !")
p(0x030AC9, "Pas assez d'argent !")
p(0x030ADB, "Sacha a vaincu\n")
p(0x030AE5, "Lance Lutte !")

# ============================================================
# 2. MENU DE COMBAT
# ============================================================

p(0x030588, "ATQ.")       # ATTAQ officiel, raccourci pour laisser une case avant Objet
p(0x03058E, "Objet")      # Item
p(0x030594, "PKMN")       # PKMN
p(0x030599, "Fuite")      # Libellé officiel complet, relogé par le repacker
...
p(0x030634, " ")             # Séparateur avant « <Pokémon> est K.O. ! »
p(0x030646, "Changer de Pokémon ?")
p(0x030659, "Oui Non")      # Yes No
p(0x0306C9, "PV restaurés !")   # Recovered HP
p(0x03070B, " se réveille !")  # Woke up
p(0x03075C, "Reçu : ")       # Montant ou objet reçu, routine partagée
p(0x030765, "Sacha perd ")   # Lost, suivi du montant
p(0x03076B, "00Dresseur ")   # Défaite : Dresseur <nom> / gagne !
...
p(0x0308D3, "0Magasin    ")      # Item Shop
p(0x0308E9, "Combien ?   ")      # How Many?
p(0x0308F6, "Merci !    ")       # Thank you!
p(0x03092D, "Pas de PKMN")          # No Pokemon!
        ...
        (
            (
                (
                    ...
                    "d'autres Pokémon. Finis ton Pokédex. Reviens."
                )
            )
        )
    ),
...
# Messages systeme
p(0x035F05, " veut se battre !")
p(0x035F15, "est paralysé !")
p(0x035F23, "Super efficace !")
p(0x035F34, "PokéB.")
p(0x035F3D, "Résultat : ", layout="raw")
p(0x035F57, "a évolué en ")
p(0x035F65, "Évolution annulée !")
p(0x035F75, " veut apprendre")
p(0x035F85, "Mais il connaît")
p(0x035F98, "Oublier une attaque ?", layout="raw")
p(0x035FAE, "Oublier ")
p(0x035FB6, "Adversaire : ")
p(0x0364F0, "Util. Potion Max !")
p(0x03650D, "est paralysé !")  # formule combat Rouge/Bleu FR
...
p(0x031700, "MasterB")
p(0x031709, "Potion")
p(0x031710, "Sup.Pot")          # 7 cases + 1 espace avant la quantité
p(0x031719, "Hyp.Pot")          # 7 cases + 1 espace avant la quantité
p(0x031722, "Max.Pot")          # 7 cases + 1 espace avant la quantité
p(0x03176F, "HuilMax")
p(0x031779, "SupBonb")
p(0x0317F8, "DentOr")
p(0x031803, "00Cpe CS")
...
p(0x031A15, "CapturePokémon")       # rendu 7x2 : « Capture » / « Pokémon »
p(0x031A24, "CapturePokémon100%")   # rendu 7x3, sans lettre isolée
...
p(0x031AA4, "Anti-poison")
p(0x031AB2, "État   normal")
...
p(
    ...
    (
        (
            "Poké Balls en vente au Magasin !"
        )
    ),
    layout="dialogue_19_19",
)
...
# -- Combat --
p(0x0302E4, "00Raté !")
p(0x0303BC, "000000 baisse !")
p(0x030403, "Hein ?")
p(0x03041D, "Un ")
p(0x03063B, "Critique !")
p(0x03068E, "0000000Statut inchangé !")
p(0x03072D, "Confusion dissipée !")
...
# -- Objet --
p(0x030F8E, "P.Plte")       # Pierre Plante (dans le bloc padding)
...
p(0x031EDD, "Numéro 2")     # 二当家, numéro 2 du dojo
...
p(0x03174F, "AntBrûl")      # Anti-Brûle officiel, abrégé à 7 cases
p(0x031758, "TotSoin")      # Total Soin officiel, abrégé à 7 cases
p(0x031761, "Rappel")       # Revive
p(0x031769, "Huile")        # Ether
p(0x031782, "P.Feu")        # Pierre Feu
p(0x03178B, "P.Eau")        # Pierre Eau
p(0x031794, "P.Fdr")        # Pierre Foudre
p(0x03179D, "P.Lune")       # Pierre Lune
p(0x0317A6, "Colis ")       # Parcel
p(0x0317B5, "Carte")        # Map (3 car -> tronque a 3)
p(0x0317B9, "Nautile")      # HelixFosil
p(0x0317C4, "F.Dôme")       # Fossile Dôme
p(0x0317CF, "PassBat")      # Passe Bateau
p(0x0317DA, "EauFr.")       # Eau Fraîche, identité de l'objet corrigée
p(0x0317E3, "Sc.Sylp")      # Scope Sylphe
p(0x0317EE, "PokFlût")      # Poké Flûte

# -- Descriptions d'objets --
p(0x031A0F, "Vide ")        # Empty
p(0x031AC1, "Fin du sommeil") # rendu 7x2, sans abréviation
p(0x031ADC, "Soigne brûlure") # rendu 7x2, sans abréviation
...
# -- Secret Key --
p(0x030F83, "CléSec.")      # Clé Secrète (dans padding)
...
p(0x031196, "Étincell")      # Spark, cellule de combat 8 glyphes
p(0x0311BC, "FatalFoud.")   # Thunder, menu de combat limité à 10 colonnes
...
p(0x03146F, "Étonnem.")      # Astonish, cellule de combat 8 glyphes
p(0x031496, "Ouragan")      # Twister
p(0x0314D2, "Morsure")       # Bite
p(0x0314D7, "Mâchouil")      # Crunch, cellule de combat 8 glyphes
...
p(0x03154B, "Écrasem")       # Stomp, cellule de combat 8 glyphes
p(0x031584, "Explos.")       # Explode, cellule de combat 8 glyphes
p(0x03159C, "Berceuse")      # Sing
p(0x0315A6, "Bise")          # Kiss, fragment sans pointeur propre
p(0x0315B9, "Rugissem")      # Growl, cellule de combat 8 glyphes
p(0x0315BF, "Gonflett")      # Bulk-up, cellule de combat 8 glyphes
p(0x0315DC, "Fou.")          # Whip, fragment sans pointeur propre
p(0x0315E1, "Charme")        # Charm
p(0x0315FB, "Soin")          # Recover
p(0x03160A, "Hurlemen")      # Roar, cellule de combat 8 glyphes
p(0x031624, "Malédic.")      # Curse, slot revu depuis la source chinoise
...
p(0x03069F, ": Attaque")   # Attack
p(0x030775, "gagne !")     # Won!, relogé par le repacker
...
p(0x0301EB, "En avant ! ")   # Go!, formulation Rouge/Bleu
p(0x0303A1, " monte !")      # Rose
p(0x030417, "Bravo ! ")      # suivi de l'ancienne espèce
p(0x030485, "est oubliée !")
p(0x030611, "ObjClé")       # KeyItm
p(0x030621, "Préc.")        # Acc.:, champ de cinq cases
p(0x03062E, "Sauv. ")       # Wild
p(0x0306A6, ": Défense")    # Defense
p(0x0306AF, ": Atq.Spé")    # S.Atk
p(0x0306B5, ": Déf.Spé")    # S.DE
p(0x0306BA, ": Vitesse")    # Speed
p(0x0307DA, "Envoi ")       # Send
p(0x0308E1, "Achat")        # Buy, le bouton accepte cinq colonnes
p(0x0308E5, "Vente")        # Sell, le bouton accepte cinq colonnes

# Capacites: noms complets lorsque la largeur d'affichage le permet.
p(0x0310FB, "Flammèch")      # Ember, cellule de combat 8 glyphes
p(0x031313, "Purédp.")       # Smog, cellule de combat 8 glyphes
...
p(0x03146A, "Léchouil")      # Lick, cellule de combat 8 glyphes
...
p(0x031101, "Roue Feu")           # Flame Wheel
p(0x031108, "Poing Feu")          # Fire Punch
p(0x03110F, "LanceFlam.")         # Flamethrower
p(0x031118, "Feu Sacré")          # Sacred Fire
p(0x03111F, "Déflagr.")           # Fire Blast
p(0x031138, "Pistolet O")         # Water Gun
p(0x031142, "Vibraqua")           # Water Pulse
p(0x031149, "Bulles d'O")         # Bubble Beam
p(0x031150, "Octazook")           # Octazooka, cellule de combat 8 glyphes
p(0x03115A, "PinceMasse")         # Crabhammer
p(0x031166, "Hydrocan")           # Hydro Pump, cellule de combat 8 glyphes
p(0x031170, "Tourniq.")           # Water Sport, cellule de combat 8 glyphes
p(0x031186, "Éclair")             # Thunder Shock
p(0x03118F, "Onde de Choc")       # Shock Wave, nom officiel
p(0x03119C, "Poing-Écl.")         # Thunder Punch: POING-ECLAIR officiel, raccourci
p(0x0311A5, "Tonnerre")           # Thunderbolt
p(0x0311AE, "Élecanon")           # Zap Cannon
p(0x0311B5, "Électacl")           # Volt Tackle, cellule de combat 8 glyphes
p(0x0311C4, "CageÉclair")         # Thunder Wave: CAGE-ECLAIR officiel, sans tiret
p(0x0311D4, "Méga-Sang.")         # Mega Drain: MEGA-SANGSUE officiel, raccourci
p(0x0311DB, "FeuilMagik")         # Magical Leaf
p(0x0311E2, "FouetLiane")         # Vine Whip
p(0x0311EC, "TranchHerb")         # Razor Leaf: TRANCH'HERBE officiel, raccourci
p(0x0311F3, "Poing Dard")         # Needle Arm
p(0x0311FA, "CanonGrain")         # Seed Bomb
p(0x031204, "Lance-Sol.")         # Solar Beam: LANCE-SOLEIL officiel, raccourci
p(0x03120B, "Végé-Att.")          # Frenzy Plant
p(0x031212, "Siffl'Herb")         # Grass Whistle
p(0x03121B, "PoudreDodo")         # Sleep Powder: POUDRE DODO officiel, sans espace
p(0x03122A, "Para-Spore")         # Stun Spore
p(0x031231, "Poudreus")           # Powder Snow, cellule de combat 8 glyphes
p(0x031241, "BriseGlace")         # Arctic Breeze (capacité custom)
p(0x031248, "Poinglace")          # Ice Punch: graphie officielle Rouge/Bleu
p(0x031264, "Glaciat.")           # Sheer Cold, cellule de combat 8 glyphes
p(0x031281, "Massd'Os")           # Bone Club
p(0x03128B, "Séisme")             # Earthquake
p(0x031292, "0000Osmerang")       # Bonemerang; pointeur après padding
p(0x0312A9, "JetSable")           # Sand Attack: JET DE SABLE officiel, raccourci
p(0x0312B0, "JetPierres")         # Rock Throw: JET-PIERRES officiel, sans tiret
p(0x0312B7, "Tomberoc")           # Rock Tomb, cellule de combat 8 glyphes
p(0x0312C1, "PouvAntiq.")         # Ancient Power
p(0x0312CA, "Éboulem.")           # Rock Slide, cellule de combat 8 glyphes
p(0x0312D1, "Vampir.")            # Leech Life, cellule de combat 8 glyphes
p(0x0312D8, "DoubleDard")         # Twineedle: DOUBLE-DARD officiel, sans tiret
p(0x0312DF, "VentArgent")         # Silver Wind
p(0x0312E6, "RayonSign.")         # Signal Beam
p(0x0312ED, "Mégacorn")           # Megahorn, cellule de combat 8 glyphes
p(0x0312F7, "Lumiqueue")          # Tail Glow
p(0x031301, "Sécrét.")            # String Shot, cellule de combat 8 glyphes
p(0x031308, "0000Dard-Venin")     # Poison Sting; pointeur après padding
p(0x03131D, "QueuePois.")         # Poison Tail
p(0x031324, "Croc Venin")         # Poison Fang
...
p(0x03135A, "PoingKarat")         # Karate Chop
p(0x031361, "DoublePied")         # Double Kick
p(0x031370, "MawashiG.")          # Rolling Kick
p(0x031379, "CorpsPerdu")         # Vital Throw
p(0x031380, "FrappAtlas")         # Seismic Toss
p(0x031389, "CasseBriq.")         # Brick Break
p(0x031390, "Stratop.")           # Sky Uppercut, cellule de combat 8 glyphes
p(0x031399, "Coup-Croix")         # Cross Chop
p(0x0313A0, "DynamoP.")           # Dynamic Punch
p(0x0313A9, "PoingBoost")         # Power-Up Punch
p(0x0313B2, "MitraPoing")         # Focus Punch
p(0x0313C3, "Tranch'Air")         # Air Cutter
p(0x0313CA, "Cru-Aile")           # Wing Attack
p(0x0313D1, "Aéropiqu")           # Aerial Ace, cellule de combat 8 glyphes
p(0x0313DC, "Bec Vrille")         # Drill Peck
p(0x0313EA, "Aéroblas")           # Aeroblast, cellule de combat 8 glyphes
p(0x0313F1, "Piqué")              # Sky Attack
p(0x0313F8, "ChocMental")         # Confusion
p(0x03140B, "Ball'Brume")         # Mist Ball
p(0x031415, "Choc Psy")           # Psyshock
p(0x03141F, "PsykoudB.")          # Zen Headbutt
p(0x031430, "Dévorêve")           # Dream Eater
p(0x031437, "PsychoB.")           # Psycho Boost
p(0x031458, "Plénitud")           # Calm Mind, cellule de combat 8 glyphes
p(0x031478, "PoingOmbre")         # Shadow Punch
p(0x03147F, "Ball'Ombre")         # Shadow Ball
p(0x031486, "GriffOmbre")         # Shadow Claw
p(0x03148D, "Onde Folie")         # Confuse Ray
p(0x03149E, "Draco-Rage")         # Dragon Rage
p(0x0314A5, "DracoSfl")           # Dragon Breath, cellule de combat 8 glyphes
p(0x0314AC, "DracoGrif.")         # Dragon Claw
p(0x0314B3, "Dracochoc")          # Dragon Pulse
p(0x0314BA, "DanseDraco")         # Dragon Dance
p(0x0314C1, "Sabotage")           # Knock Off
p(0x0314CB, "Feinte")             # Feint Attack
p(0x0314DE, "GrifAcier")          # Metal Claw
p(0x0314E5, "AileAcier")          # Steel Wing
p(0x0314EC, "QueueFer")           # Iron Tail
p(0x0314F6, "PoingMétéo")         # Meteor Mash
p(0x0314FD, "Mur de Fer")         # Iron Defense
p(0x03150D, "TourRapid.")         # Rapid Spin
p(0x031529, "Vive-Att.")          # Quick Attack: VIVE-ATTAQUE officiel, raccourci
p(0x031551, "ÉclatGriff")         # Crush Claw
p(0x031558, "PuisCachée")         # Hidden Power
p(0x03155F, "CrocMort")           # Hyper Fang
p(0x031566, "Coupe-Vent")         # Razor Wind
p(0x03156D, "Damoclès")           # Double-Edge
p(0x031574, "Ultralas")           # Hyper Beam, cellule de combat 8 glyphes
p(0x03157B, "Destruct")           # Self-Destruct, cellule de combat 8 glyphes
p(0x03158C, "Guillot.")           # Guillotine, cellule de combat 8 glyphes
p(0x031595, "EmpalKorne")         # Horn Drill
p(0x0315A1, "Grobisou")           # Lovely Kiss (Love Kiss dans le bootleg)
p(0x0315AB, "Ultrason")           # Supersonic
p(0x0315B2, "DanseLames")         # Swords Dance
p(0x0315C7, "BoulArmure")         # Defense Curl
p(0x0315D7, "Mimi-Queue")         # Tail Whip
p(0x0315E7, "Brouill.")           # Smokescreen, cellule de combat 8 glyphes
p(0x0315F4, "Reflet")             # Double Team
p(0x03160F, "Cyclone")            # Whirlwind
p(0x03163B, "Poud.Toxik")         # Poison Powder: POUDRE TOXIK officiel, raccourci
...
p(0x0301F0, "sauvage ")
p(0x030381, " souffre du poison !")
p(0x030392, " a trop peur !")
p(0x0303C8, " baisse fort !")
p(0x0303E6, "Merci")
p(0x0303EB, "Merci")
p(0x0303F0, "Merci")
p(0x0303F6, "Merci")
...
p(0x0304C2, " rayonne !")
p(0x0304CF, " se décharge !")   # suffixe après nom, 14 cases au maximum
p(0x0304DB, " creuse un trou !")
p(0x0304E7, " frappe vite !")
p(0x0304F1, " se concentre !")
p(0x0304FB, " frappe à fond !")
p(0x030505, " se concentre !")
p(0x03050F, " frappe à fond !")
p(0x030519, "cesse de se concentrer !")
p(0x030523, " s'envole !")
p(0x03052D, " se sacrifie !")
p(0x030537, " se concentre !")
p(0x030541, " libère sa force !")
p(0x03054B, " prévoit un coup !")
p(0x030555, " subit Prescience !")
...
p(0x0349E5, "Huile reçue !", layout="dialogue_19_19")
p(0x0349F2, "Huile Max reçue !", layout="dialogue_19_19")
...
# Le pointeur de Morphing visait encore le résidu "??????????" de Luiga.
p(0x031619, "Morphing")
