...
ENGLISH_BRIDGE_PATH = (
    TOOLS_DIR / "mesen_fm3_route1_viridian_en_after_prototype.lua"
)
CONTINUATION_PATH = (
    TOOLS_DIR
...
class MesenFm3Route1ViridianTraceTests(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.english_bridge = ENGLISH_BRIDGE_PATH.read_text(encoding="utf-8")
    ...
    def test_continuation_window_is_bounded_and_configurable(self) -> None:
        required_trace = (
            ...
            'rawget(_G, "POKEMON_FM3_ROUTE1_BATTLE_RECOVERY_START")',
    ...
    def test_english_bridge_recovers_battles_from_route1_entry(self) -> None:
        self.assertIn(
