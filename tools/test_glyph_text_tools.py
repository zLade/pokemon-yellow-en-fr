...
class GlyphTextToolsTests(unittest.TestCase):
    ...
    def test_english_pointer_collapses_zero_padding_before_join_space(self) -> None:
        source = b"\0" * 10 + b"000000 Fell"
        self.assertEqual(
            relocated_text_target(
                source,
                10,
        ...
        # The historical French/default path remains byte-compatible.
        self.assertEqual(
            relocated_text_target(
                source,
                10,
    ...
    def test_english_join_space_survives_graphical_source_collapse(self) -> None:
        source = b"\0" * 10 + b"0000\xB0\xA1\xB0\xA2"
        self.assertEqual(
            relocated_text_target(
                source,
                10,
