...
EXPECTED_INPUT_SHA256 = {
    ...
    "script": (
        "2a875ed9958d68d773fccd6ba29c8db7f7b4989da31c9944d"
        "1d39f9f21c32a8f"
    ),
    "canonical_csv": (
        "a1ddae08ed139d1b7f5c107aab424da6bb2af9ad3f8496061a"
        "1c5444c87fe46f"
    ),
    "canonical_overflow_csv": (
        "759bbe3b53fd309e713336fa836a85d28176b242e9b95a7903"
        "82aef61edd691d"
    ),
...
CURRENT_ARTIFACTS = {
    ...
    "Pokemon_Jaune_FR_repacked_title.nes": (
        "build/Pokemon_Jaune_FR_credits.nes"
    ),
    "Pokemon_Jaune_FR_repacked_title.ips": (
        "releases/fr/2.0.1/Pokemon_Jaune_FR_v2.0.1.ips"
    ),
...
class ReleaseBuilder:
    ...
    def build_once(self, run_directory: Path, csv_path: Path) -> None:
        ...
        title_rom = (
            run_directory / "Pokemon_Jaune_FR_title_before_dojo_restore.nes"
        )
        title_ips = (
            run_directory / "Pokemon_Jaune_FR_title_before_dojo_restore.ips"
        )
        chinese_bps = (
            run_directory
            / "Pokemon_Jaune_FR_repacked_title_from_chinese.bps"
        ...
        self.run_step(
            ...
            (
                self.input_paths["restore_chinese_dojo_deputy"],
                "--rom",
                title_rom,
                "--chinese-rom",
                self.input_paths["chinese_rom"],
